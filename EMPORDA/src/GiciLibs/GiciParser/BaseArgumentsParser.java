...
/**
 * Arguments parser definition (useful for extending in other classe). This class analyses a string of arguments and extract and check its validity.
 * Use example:
 *
...
public abstract class BaseArgumentsParser {
	...
	/**
	 * Abstract method. Define it in a subclass.
	 * It is called whenever an argument is found.
	 *
	 */
	public abstract void parseArgument( int argFound, String[] options ) throws ParameterException ;
	 ...
	 */
	public void parse(String[][] argumentsSpecification, String[] args) throws ParameterException, ErrorException{
		//Copy parameters
		...
		while(argNum < args.length){
			...
			if (argFound != -1) {
				...
				parseArgument(argFound, options);
			} else {
